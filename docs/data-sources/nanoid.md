...
- `alphabet` (String) The alphabet to use for ID generation. Can be 'alphanumeric' (a-zA-Z0-9), 'numeric' (0-9), 'readable' (excludes 0/O, 1/l/I) or a custom string of characters.
